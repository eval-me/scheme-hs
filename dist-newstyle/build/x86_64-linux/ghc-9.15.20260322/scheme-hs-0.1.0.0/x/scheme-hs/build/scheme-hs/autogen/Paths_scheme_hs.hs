...
-- at runtime using the environment variable scheme_hs_bindir.
...
-- environment variable scheme_hs_libdir.
...
-- using the environment variable scheme_hs_dynlibdir.
...
-- runtime using the environment variable scheme_hs_datadir.
...
-- using the environment variable scheme_hs_sysconfdir.
...
libdir     = "/home/pedro/.cabal/lib/x86_64-linux-ghc-9.15.20260322-bfbf/scheme-hs-0.1.0.0-inplace-scheme-hs"
dynlibdir  = "/home/pedro/.cabal/lib/x86_64-linux-ghc-9.15.20260322-bfbf"
datadir    = "/home/pedro/.cabal/share/x86_64-linux-ghc-9.15.20260322-bfbf/scheme-hs-0.1.0.0"
libexecdir = "/home/pedro/.cabal/libexec/x86_64-linux-ghc-9.15.20260322-bfbf/scheme-hs-0.1.0.0"
sysconfdir = "/home/pedro/.cabal/etc"

getBinDir     = catchIO (getEnv "scheme_hs_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "scheme_hs_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "scheme_hs_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "scheme_hs_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "scheme_hs_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "scheme_hs_sysconfdir") (\_ -> return sysconfdir)
